...
public class RenameTransformationTest {
	private static final Logger LOG = LoggerFactory.getLogger(RenameTransformationTest.class);
	...
	public void testFindNodes() throws Exception {
		...
		r = new RenameTransformation(Utils.list("bookstore", "book", "category"), "bookCat").transform(r);
		LOG.info(DataNode.printElement(r));
		...
		found = DataNode.findList(r, Utils.list("bookstore", "book", "bookCat"));
		assertEquals(found.size(), 3);
